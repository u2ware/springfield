package com.u2ware.springfield.repository.sqlsession.test4;
...
import com.u2ware.springfield.repository.sqlsession.test1.SpringfieldPagination;
import com.u2ware.springfield.repository.sqlsession.test2.SpringfieldQuery;
import com.u2ware.springfield.repository.sqlsession.test3.SpringfieldQueryTemplate;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration
public class CompositeConfigTest extends AbstractContextTestRoot {

	@Autowired @Qualifier("springfieldPaginationRepository")
	...
	@Autowired @Qualifier("springfieldQueryTemplateRepository")
