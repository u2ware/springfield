...
@WebAppConfiguration
public class GenericControllerDeleteTest {
    ...
    public void testDelete1() throws Exception{
    	...
    	logger.warn("===================================================");
    	this.mockMvc.perform(delete("/consumer/a")
    			.contentType(MediaType.APPLICATION_JSON)
    			)
    			.andExpect(status().isOk());

        logger.warn("===================================================");
    	String url = this.mockMvc.perform(delete("/consumer/a.xyz")
    			)
    			.andDo(print())
    			.andExpect(status().isOk())
    			.andExpect(model().errorCount(1))
    			.andReturn().getResponse().getForwardedUrl();
    	Assert.assertEquals("/consumer/delete.xyz", url);
    ...
    public void testDelete2() throws Exception{
        ...
        logger.warn("===================================================");
    	this.mockMvc.perform(delete("/consumer/a.xyz")
    			)
    			.andExpect(status().isOk())
    			.andExpect( model().errorCount(1));
