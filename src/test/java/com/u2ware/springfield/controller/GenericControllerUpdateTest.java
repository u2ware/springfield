...
@WebAppConfiguration
public class GenericControllerUpdateTest {
    ...
    public void testUpdate1() throws Exception{
    	...
    	logger.warn("===================================================");
    	this.mockMvc.perform(put("/consumer/a")
    			.contentType(MediaType.APPLICATION_JSON)
    			.content(new ObjectMapper().writeValueAsString(new Consumer("a","ccc")))
    			)
    			.andExpect(status().isOk());

    	
    	logger.warn("===================================================");
    	String url = this.mockMvc.perform(put("/consumer/a.xyz")
    				.param("password", "DDD")
    			)
    			.andDo(print())
    			.andExpect(status().isOk())
    	...
    	Assert.assertEquals("/consumer/update.xyz", url);
    }
    ...
    public void testUpdate2() throws Exception{
        ...
        logger.warn("===================================================");
    	this.mockMvc.perform(put("/consumer/a.xyz")
    			)
    			.andExpect(status().isOk())
