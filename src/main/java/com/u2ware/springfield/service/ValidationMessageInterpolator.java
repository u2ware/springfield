...
public class ValidationMessageInterpolator implements MessageInterpolator, MessageSourceAware{
    ...
    public static class ValidationMessage extends ReloadableResourceBundleMessageSource {

        public ValidationMessage() {
    		setBasename("classpath:/com/u2ware/springfield/service/ValidationMessage");
        }
